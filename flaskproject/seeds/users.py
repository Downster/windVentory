...
def seed_users():
    ...
    brendan = User(
        public_id=str(uuid.uuid4()), email='imbrandan@gmail.com', first_name='Brendan', last_name='Downing', password=generate_password_hash('password', method='sha256'), phone_number='408-916-6314', image='https://fionacapstonebucket.s3.us-west-1.amazonaws.com/defaults/09fb955ae10c4aff9708b4d6293fd1d8.png', team_lead=True)
    karis = User(
        public_id=str(uuid.uuid4()), email='kgardner@gmail.com', first_name='Karis', last_name='Gardner', password=generate_password_hash('password1234', method='sha256'), phone_number='408-917-6314', image='https://fionacapstonebucket.s3.us-west-1.amazonaws.com/defaults/09fb955ae10c4aff9708b4d6293fd1d8.png', team_lead=True)
    tony = User (
    ...
    darren = User (
        public_id=str(uuid.uuid4()), email='dkrongus@gmail.com', first_name='Darren', last_name='kong', password=generate_password_hash('password456', method='sha256'), phone_number='408-901-6314', image='https://fionacapstonebucket.s3.us-west-1.amazonaws.com/defaults/09fb955ae10c4aff9708b4d6293fd1d8.png', team_lead=True)
    chris = User (
